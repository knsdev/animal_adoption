...
<form method="POST" enctype="multipart/form-data" style="max-width: 600px">
  <div>
    ...
    <div class="form-group d-flex flex-row justify-content-start align-items-center gap-4 mt-3">
      ...
      <input <?= (isset($_POST['vaccinated']) && $_POST['vaccinated']) ? 'checked' : '' ?> type="checkbox" class="form-check-input" style="width: 2rem; height: 2rem;" name="vaccinated" id="vaccinated" value="1">
    </div>
